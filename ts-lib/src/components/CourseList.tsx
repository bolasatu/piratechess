...
// Define Chapter interface based on API response
interface Chapter {
    id: number;
    name?: string;
}
...
const CourseList: React.FC<CourseListProps> = ({ courses }) => {
    ...
    const toggleChapters = async (bid: string, name: string) => {
        ...
        try {
            ...
            // Create simulated chapters for demonstration
            // In a real app, you would get this from an API call
            const sampleChapters: Chapter[] = Array.from({ length: 5 }, (_, i) => ({
                id: i + 1,
                name: `Chapter ${i + 1}: ${name} section ${i + 1}`
            }));
